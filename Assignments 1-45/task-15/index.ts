const Guest_List: string[] = ['Mama', 'My Crush ', 'Bareera']

console.log(`Unfortunately, ${Guest_List[1]} would not be able to make it to the Dinner`)
